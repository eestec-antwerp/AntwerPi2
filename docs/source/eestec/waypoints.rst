...
We can transform a route you programmed into an actual route for the drone, using the file `waypoints.py <https://raw.githubusercontent.com/eestec-antwerp/AntwerPi2/master/waypoints/waypoints.py>`_ (right-click and choose 'Save link as'). Download it and put it next to your ``main.py``.
